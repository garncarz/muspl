...
♪ melody{start:(5, 1, g), relative:(g, 1, 8),
	pitch:[0, -1:1, 0, 0, -1:1, 0, 2], len:[1*6, exact{dur:[4, 8, 4]}]}.
...
♪ melody{start:(9, 1, g), relative:(d, 2, 8),
	pitch:[0*4, -1:1, 0, 2], len:[1*6, exact{dur:[4, 8, 4]}]}.
♪ melody{start:(9, 1, g), relative:(bes, 1, 8),
	pitch:[0*6, 2], len:[1*6, exact{dur:[4, 8, 4]}]}.
♪ melody{start:(9, 1, g), relative:(f, 1, 8),
	pitch:[0*6, 3], len:[1*6, exact{dur:[4, 8, 4]}]}.
♪ melody{start:(9, 1, f), relative:(bes, -1, 8), pitch:mel07}.

♪ copyBars{from:9, to:10, cond:isStaff(f)}.

♪ melody{start:(11, 1, g), relative:(c, 2, 8),
	pitch:[0*4, -1:1, 0, 3], len:[1*6, exact{dur:[4, 8, 4]}]}.
...
♪ melody{start:(15, 1, g), relative:(a, 1, 8),
	pitch:[0, 1, 0, -1, 0, -1, -2], len:[1*6, exact{dur:[4, 8, 4]}]}.
♪ melody{start:(15, 1, g), relative:(f, 1, 8),
	pitch:[0, 1, 0, -1, -1, -1, -3], len:[1*6, exact{dur:[4, 8, 4]}]}.
